...
Matrix4::Matrix4(float m0, float m1, float m2, float m3, float m4, float m5, float m6, float m7, float m8, float m9,
...
{
	setScale(pos.m_x, pos.m_y, pos.m_z);
}
...
{
	Vector4 result;
	result.m_x = m[0] * rhs.m_x + m[4] * rhs.m_y + m[8] * rhs.m_z + m[12] * rhs.m_w;
	result.m_y = m[1] * rhs.m_x + m[5] * rhs.m_y + m[9] * rhs.m_z + m[13] * rhs.m_w;
	result.m_z = m[2] * rhs.m_x + m[6] * rhs.m_y + m[10] * rhs.m_z + m[14] * rhs.m_w;
	result.m_w = m[3] * rhs.m_x + m[7] * rhs.m_y + m[11] * rhs.m_z + m[15] * rhs.m_w;
